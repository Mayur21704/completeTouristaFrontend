...
//   const { id, passengerId, segment } = useParams();
...
//   // ... (keeping all the existing useEffect hooks)
//   useEffect(() => {
...
//     const segmentType = segment === "return" ? "return" : "outbound";
...
//       navigate(
//         segment === "return"
//           ? `/returnSeatBooking/${id}/return/${nextPassenger}`
//           : `/seatBooking/${id}/${nextPassenger}`
//       );
//     }
//   };
...
//     navigate(`/returnSeatBooking/${id}/return/1`);
//   };

//   const isRoundTrip = selectedFlight?.itineraries?.length === 2;
...
//                     <span>
//                       {
//                         selectedFlight.itineraries[segment === "return" ? 1 : 0]
...
//               {seatsLocked && isRoundTrip && segment !== "return" && (
//                 <motion.button
//                   whileHover={{ scale: 1.02 }}
//                   whileTap={{ scale: 0.98 }}
//                   onClick={handleBookReturnFlight}
