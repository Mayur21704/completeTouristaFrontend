  ...
  return (
    ...
    >
      <div className="flex flex-col md:flex-row items-stretch">
        <div className="w-full md:w-[280px] h-[200px] md:h-auto relative overflow-hidden">
          <motion.div
            ref={imageRef}
            initial={{ scale: 1.2 }}
            className="w-full h-full"
        ...
        <div className="flex-1 p-4 md:p-6 flex">
          <div className="flex-1">
            <div className="flex flex-col md:flex-row md:items-start justify-between mb-3 gap-2">
              <div>
                <h2 className="text-lg md:text-xl font-bold text-gray-900 mb-2 group-hover:text-blue-600 transition-colors">
                  {hotel.name}
                </h2>
              </div>
              <div className="flex flex-row md:flex-col items-center md:items-end gap-2 md:gap-0">
                ...
                <div className="text-sm text-gray-600 font-medium md:text-right">
                  + ₹{taxesAndFees.toLocaleString()} taxes & fees
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-wrap gap-2 md:gap-3 mb-4">
              <motion.div
                whileHover={{ scale: 1.05 }}
                className="px-2 md:px-3 py-1.5 bg-blue-50 rounded-full flex items-center"
              >
                <Users className="w-4 h-4 text-blue-600 mr-1.5" />
            ...
            <div className="flex flex-wrap gap-2 mb-4 md:mb-6">
              ...
              {hotel.amenities.length > 3 && (
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  onClick={() => onShowAmenities(hotel)}
                  className="text-xs md:text-sm text-blue-600 font-medium flex items-center hover:text-blue-700"
                >
                  <Plus className="w-3 h-3 mr-1" />
                  {hotel.amenities.length - 3} more
                </motion.button>
            ...
            <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-3 md:gap-0">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                onClick={() => onBook(hotel)}
                className="w-full md:w-auto flex items-center justify-center gap-2 px-6 py-2.5 bg-blue-600 text-white rounded-xl hover:bg-blue-700 transition-colors"
              >
                Book Now
                <ArrowRight className="w-4 h-4" />
              </motion.button>
      ...
      <div className="max-w-6xl mx-auto px-4 py-8 md:py-12">
        ...
        >
          ...
          <motion.div
            ...
            animate={{ opacity: 1 }}
            transition={{ delay: 0.4 }}
            className="flex flex-col md:flex-row justify-center gap-3 md:gap-4 mt-6 md:mt-8"
          >
            <motion.button
              whileHover={{ scale: 1.02 }}
              whileTap={{ scale: 0.98 }}
              onClick={() => handleSort("lowToHigh")}
              className={`px-4 py-2 rounded-xl flex items-center justify-center gap-2 text-sm font-medium transition-all ${
                sortOrder === "lowToHigh"
                  ? "bg-blue-600 text-white"
                  : "bg-white text-gray-700 hover:bg-gray-50"
              }`}
        ...
        {showAmenitiesModal && (
          ...
          >
            <motion.div
              ...
              exit={{ scale: 0.95, opacity: 0 }}
              onClick={(e) => e.stopPropagation()}
              className="bg-white rounded-2xl p-4 md:p-6 max-w-2xl w-full max-h-[80vh] overflow-y-auto m-4"
            >
              <div className="flex justify-between items-center mb-6">
