        ...
        <div className="fixed inset-0 z-[9999]">
          ...
          <div className="fixed inset-0 flex items-center justify-center pointer-events-none p-4">
            <motion.div
              ...
              className="bg-white rounded-xl p-8 max-w-md w-full shadow-xl relative pointer-events-auto"
            ...
            {bookings.length === 0 ? (
              ...
              bookings.map((booking) => (
                <motion.div
                  ...
                  className="booking-card bg-white rounded-2xl shadow-sm p-6 hover:shadow-md transition-shadow"
